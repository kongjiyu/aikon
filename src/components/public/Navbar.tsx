...
interface MegaMenuItem {
  ...
  trendyTitle: string; // Keeping for fallback or specific layout if needed, though structure changes
  trendyItem: { name: string; url: string }; // Keeping for others?
...
const MEGA_MENU_DATA: Record<string, MegaMenuItem> = {
  'Laptop': {
    title: 'Laptop',
    subcategories: [
      { name: 'Gaming Laptop', items: ['ROG - Republic of Gamers', 'TUF Gaming', 'ASUS Gaming'] },
      { name: 'Home Laptop', items: ['Copilot + PC devices', 'Tablet & 2 in 1 laptop', 'Thin and light', 'High Performance', 'Everyday use', 'OLED category'] },
      { name: 'Business Laptop', items: ['ExpertBook', 'ProArt'] },
      { name: 'Apple Mac', items: ['MacBook Air', 'MacBook Pro'] }
    ],
    trendyTitle: 'Trendy Laptop',
    trendyItem: { name: 'ASUS TUF GAMING A15', url: '/products/asus-tuf' },
    bannerImage: '/images/promotionSalesPoster.png', // Updated per request
  },
  'Personal Computer': {
    title: 'PCs',
    subcategories: [
      { name: 'All-in-One PCs', items: ['ASUS AiO', 'Apple iMac'] },
      { name: 'Tower PCs', items: ['ROG Strix', 'Dell XPS'] },
      { name: 'Gaming Tower PCs', items: ['Alienware', 'Omen'] },
      { name: 'Mini PCs', items: ['Mac Mini', 'Intel NUC'] }
    ],
  ...
  'Phone': {
    title: 'Phone',
    subcategories: [
      { name: 'Oppo', items: ['Find X Series', 'Reno Series', 'A Series'] },
      { name: 'Apple', items: ['iPhone 15 Pro', 'iPhone 15', 'iPhone 14'] },
      { name: 'Huawei', items: ['Pura 70', 'Mate 60', 'Nova 12'] },
      { name: 'Samsung', items: ['Galaxy S24', 'Galaxy Z Fold', 'Galaxy A'] },
      { name: 'Xiaomi', items: ['Xiaomi 14', 'Redmi Note 13', 'Poco F6'] }
    ],
    trendyTitle: 'Trendy Phone',
    trendyItem: { name: 'Apple iPhone 17 Pro Max', url: '/products/iphone-17' },
    bannerImage: '/images/phonePoster.png',
  },
  // Simplified placeholders for Tablets/Accessories to follow structure
  'Tablets': {
    title: 'Tablets',
    subcategories: [{ name: 'Apple', items: ['iPad Pro', 'iPad Air'] }, { name: 'Samsung', items: ['Galaxy Tab S9'] }],
  ...
  'Accessories': {
    title: 'Accessories',
    subcategories: [
      { name: 'Mice and Mouse Pads', items: ['Gaming Mice', 'Ergonomic Mice'] },
      { name: 'Headsets and Audio', items: ['Wireless Headsets', 'Earbuds'] },
      { name: 'Watch', items: ['Sport Watch', 'Smart Watch', 'Digital Watch', 'GPS Watch', 'Watch Strap'] },
      { name: 'Streaming Kit', items: ['Webcams', 'Microphones'] },
      { name: 'Adapters and Charges', items: ['Power Banks', 'Cables'] },
      { name: 'Apparel Bags and Gear', items: ['Backpacks', 'Shirts'] },
      { name: 'Cases and Protection', items: ['Phone Cases', 'Laptop Sleeves'] },
      { name: 'Docks Dongles and Cable', items: ['USB Hubs', 'HDMI Cables'] },
      { name: 'Keyboards', items: ['Wired Keyboards', 'Mechanical Keyboards', 'Membrane Keyboards'] }
    ],
              ...
              <div className="bg-white border-t border-gray-100 shadow-xl rounded-b-2xl overflow-hidden mt-0">
                <div className="grid grid-cols-12 min-h-[450px]">
                  ...
                  {activeContent ? (
                    <>
                      ...
                      <div className="col-span-3 py-6 px-6 border-r border-gray-100">
                        <div className="flex justify-between items-center mb-6">
                          ...
                          <Link href="/products" className="text-[10px] font-bold text-[#023337] opacity-60 hover:opacity-100">View All</Link>
                        </div>
                      ...
                      {activeSubData ? (
                          ...
                          <div className="col-span-3 py-6 px-6 border-r border-gray-100">
                            ...
                            <ul className="space-y-4">
                              {activeSubData.items.map((item) => (
                                <li key={item}>
                                  <Link href={`/products?q=${encodeURIComponent(item)}`} className="flex items-center justify-between text-sm text-gray-600 hover:text-[#0D3F4A] font-medium group">
                                    {item}
                                  </Link>
                                </li>
                              ))}
                        ...
                        <div className="col-span-7 relative bg-white group cursor-pointer hover:opacity-95 transition-opacity h-full min-h-[450px]">
                          <Link href="/products" className="absolute inset-0 z-20"></Link>
                          <Image
                            src="/images/PICK.png"
                    ...
                    <div className="col-span-10 relative bg-white group cursor-pointer hover:opacity-95 transition-opacity h-full min-h-[450px]">
                      <Link href="/products" className="absolute inset-0 z-20"></Link>
                      <Image
                        src="/images/PICK.png"
                        alt="Pick of the Week"
