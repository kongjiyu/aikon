        ...
        <div className="px-6 pb-6">
            <div className="overflow-x-auto rounded-lg border border-gray-200">
                ...
                <tbody className="divide-y divide-gray-50">
                    {[
                        { name: 'iPhone 15 Pro Max 256GB', category: 'Smartphones', price: ',199', stock: 45, icon: Smartphone },
                        { name: 'MacBook Air 15" M3', category: 'Laptops', price: ',299', stock: 28, icon: Laptop },
                        { name: 'Samsung Galaxy S24 Ultra', category: 'Smartphones', price: ',299', stock: 32, icon: Smartphone },
                        { name: 'iPad Pro 12.9" (M2)', category: 'Tablets', price: ',099', stock: 15, icon: Tablet },
                        { name: 'Sony WH-1000XM5', category: 'Audio', price: '', stock: 50, icon: Headphones },
                        { name: 'Apple Watch Ultra 2', category: 'Wearables', price: '', stock: 12, icon: Watch },
                        { name: 'Logitech MX Master 3S', category: 'Accessories', price: '', stock: 85, icon: Gamepad2 },
                        { name: 'PlayStation 5 Slim', category: 'Gaming', price: '', stock: 8, icon: Gamepad2 },
                    ].map((item, i) => (
