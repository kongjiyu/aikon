                            ...
                            <table className="w-full text-sm text-left">
                                ...
                                <tbody className="divide-y divide-gray-100">
                                    <tr>
                                        ...
                                        <td className="px-4 py-4 text-gray-600">RM899.99</td>
                                        <td className="px-4 py-4 text-gray-600">1</td>
                                        <td className="px-4 py-4 text-right font-medium text-gray-900">RM899.99</td>
                                    </tr>
                                </tbody>
                                <tfoot className="bg-gray-50 border-t border-gray-200">
                                    <tr>
                                        <td colSpan={3} className="px-4 py-3 text-right text-gray-600 font-medium">Refund Amount</td>
                                        <td className="px-4 py-3 text-right font-bold text-gray-900">RM899.99</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                    ...
                    <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
                        ...
                        <div className="p-8">
                            ...
                            <p className="text-gray-600 text-center mb-6">
                                This will initiate a refund of <strong>RM899.99</strong> to the customer's original payment method. This action cannot be undone.
                            </p>
