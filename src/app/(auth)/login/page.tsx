...
export default function LoginPage() {
  ...
  // Check for pre-filled data from registration
  useEffect(() => {
    ...
    if (registeredEmail && registeredPassword) {
      ...
      // Clear the session storage after pre-filling
        ...
        <div className="w-full max-w-md">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 border-gray-300 rounded text-[#6B8784] focus:ring-[#6B8784]"
                />
                <span className="text-sm text-gray-700">Remember me</span>
              </label>
              <Link href="/forgot-password" className="text-sm text-[#6B8784] hover:text-[#5a726f] font-medium">
                Forgot Password?
              </Link>
            </div>
          ...
          <div className="mt-6 space-y-3">
            ...
            >
              ...
              <span className="text-[#6B8784] font-medium">Log in with Google</span>
            </button>
            ...
            >
              ...
              <span className="text-[#6B8784] font-medium">Log in with Apple</span>
            </button>
          </div>
          ...
          <p className="text-center text-sm text-gray-600 mt-8">
            No account yet?{' '}
            <Link href="/register" className="text-[#6B8784] hover:text-[#5a726f] font-semibold">
              Sign Up
            </Link>
          </p>
        </div>
